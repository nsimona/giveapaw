        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={4}>
            ...
            <Typography variant="body2">
              Този проект е част от моята дипломна работа на тема: Проектиране и
              разработване на уеб приложение с персонализирани препоръки в среда
              на микросъврисна архитектура{" "}
