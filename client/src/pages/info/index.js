  ...
  return (
    <Container maxWidth="md" sx={{ my: 5 }}>
      ...
      <Typography variant="body1" sx={{ my: 3 }}>
        ...
        имплементация на recommendation engine в среда на микросървисна
        архитектура
      </Typography>
      <Typography variant="body1" sx={{ my: 3 }}>
        Магистърската теза, представя резултатите от моите изследвания и усилия
        в областта на иновациите в приложенията за осиновяване на домашни
      ...
      <Typography variant="body1" sx={{ my: 3 }}>
        ...
        персонализирани препоръки и машинно обучение, моето приложение цели да
        направи срещата между животните и техните нови собственици по-гладка,
        сърдечна и удовлетворителна.
      </Typography>
      <Typography variant="body1" sx={{ my: 3 }}>
